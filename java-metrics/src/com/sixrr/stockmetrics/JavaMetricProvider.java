...
public class JavaMetricProvider implements MetricProvider
{
	...
	private static final String CLASS_COUNT_PROFILE_NAME = StockMetricsBundle.message("class.count.metrics.profile.name");
	private static final String CHIDAMBER_KEMERER_PROFILE_NAME = StockMetricsBundle.message("chidamber.kemerer.metrics.profile.name");
