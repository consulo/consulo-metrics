...
public class DiffDistributionDialog extends DialogWrapper
{
	...
	public DiffDistributionDialog(
			Project project, String metricName, String category, MetricType metricType, Double[] datapoints, Double[] prevDatapoints)
	{
		super(project, false);
	...
	private XYSeriesCollection createDistributionSeries()
	{
		...
		for(int i = 0; i < strippedPrevDataPoints.length; i++)
		{
			...
			prevSeries.add(strippedPrevDataPoints[i], (double) (i + 1) * 100.0 / (double) strippedPrevDataPoints.length);
		}
