...
class EditThresholdsAction extends AnAction
{
	...
	{
		super(MetricsReloadedBundle.message("edit.thresholds.action"), MetricsReloadedBundle.message("edit.threshold.values.for.this.metric.profile"),
	...
	public void actionPerformed(AnActionEvent event)
	{
		...
		final ThresholdDialog dialog = new ThresholdDialog(project, profile.getName(), metrics, results);
		dialog.show();
		if(dialog.isOK())
		{
